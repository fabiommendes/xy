...
namespace glm
{
	...
	GLM_FUNC_QUALIFIER mat<2, 2, T, Q> colMajor2(
		const vec<2, T, Q>& v1,
		const vec<2, T, Q>& vec2)
	{
		return mat<2, 2, T, Q>(v1, vec2);
	}
	...
	GLM_FUNC_QUALIFIER mat<4, 4, T, Q> colMajor4(
		...
		const vec<4, T, Q>& v4)
	{
		return mat<4, 4, T, Q>(v1, vec2, v3, v4);
	}
