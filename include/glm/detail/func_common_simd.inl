...
namespace detail
{
	...
	{
		GLM_FUNC_QUALIFIER static vec<4, float, Q> call(vec<4, float, Q> const& v1, vec<4, float, Q> const& vec2)
		{
			vec<4, float, Q> result;
			result.data = _mm_min_ps(v1.data, vec2.data);
			return result;
		}
	};
	...
	{
		GLM_FUNC_QUALIFIER static vec<4, int, Q> call(vec<4, int, Q> const& v1, vec<4, int, Q> const& vec2)
		{
			vec<4, int, Q> result;
			result.data = _mm_min_epi32(v1.data, vec2.data);
			return result;
		}
	};
	...
	{
		GLM_FUNC_QUALIFIER static vec<4, uint, Q> call(vec<4, uint, Q> const& v1, vec<4, uint, Q> const& vec2)
		{
			vec<4, uint, Q> result;
			result.data = _mm_min_epu32(v1.data, vec2.data);
			return result;
		}
	};
	...
	struct compute_max_vector<4, float, Q, true>
	{
		...
		{
			vec<4, float, Q> result;
			result.data = _mm_max_ps(v1.data, vec2.data);
			return result;
		}
	};
	...
	struct compute_max_vector<4, int, Q, true>
	{
		...
		{
			vec<4, int, Q> result;
			result.data = _mm_max_epi32(v1.data, vec2.data);
			return result;
		}
	};
	...
	struct compute_max_vector<4, uint, Q, true>
	{
		...
		{
			vec<4, uint, Q> result;
			result.data = _mm_max_epu32(v1.data, vec2.data);
			return result;
		}
	};
