...
#	endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<3, T, Q> operator+(vec<3, T, Q> const& v1, vec<3, T, Q> const& vec2)
	{
		return vec<3, T, Q>(
			v1.x + vec2.x,
			v1.y + vec2.y,
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR bool operator==(vec<3, T, Q> const& v1, vec<3, T, Q> const& vec2)
	{
		return
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<3, bool, Q> operator&&(vec<3, bool, Q> const& v1, vec<3, bool, Q> const& vec2)
	{
		return vec<3, bool, Q>(v1.x && vec2.x, v1.y && vec2.y, v1.z && vec2.z);
	}
