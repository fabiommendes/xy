...
#	endif
	...
	{
		static bool call(vec<4, float, Q> const& v1, vec<4, float, Q> const& vec2)
		{
			return _mm_movemask_ps(_mm_cmpeq_ps(v1.data, vec2.data)) != 0;
		}
	};
...
#	if GLM_ARCH & GLM_ARCH_SSE41_BIT
	...
	{
		static bool call(vec<4, int, Q> const& v1, vec<4, int, Q> const& vec2)
		{
			//return _mm_movemask_epi8(_mm_cmpeq_epi32(v1.data, vec2.data)) != 0;
			__m128i neq = _mm_xor_si128(v1.data, vec2.data);
...
#	endif
	...
	struct compute_vec4_nequal<float, Q, false, 32, true>
	{
		static bool call(vec<4, float, Q> const& v1, vec<4, float, Q> const& vec2)
		{
			return _mm_movemask_ps(_mm_cmpneq_ps(v1.data, vec2.data)) != 0;
		}
	};
...
#	if GLM_ARCH & GLM_ARCH_SSE41_BIT
	...
	struct compute_vec4_nequal<int, Q, true, 32, true>
	{
		static bool call(vec<4, int, Q> const& v1, vec<4, int, Q> const& vec2)
		{
			//return _mm_movemask_epi8(_mm_cmpneq_epi32(v1.data, vec2.data)) != 0;
			__m128i neq = _mm_xor_si128(v1.data, vec2.data);
			return _mm_test_all_zeros(neq, neq) != 0;
		}
	};
